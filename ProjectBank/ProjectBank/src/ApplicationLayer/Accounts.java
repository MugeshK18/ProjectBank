...
//	public abstract void credit(int accNo,double amount);
	...
	public void get_totalAccountHolderDetails() {
		...
		System.out.println("AccountHolderId FirstName    LastName     Age  Gender  PhoneNo       EmailId               City          Address  ");
		for(int i=0;i<size;i++) {
		System.out.print(listss.accountHolderIdL.get(i)+"                ");
		System.out.print(listss.firstNameL.get(i)+"             ");
		System.out.print(listss.lastNameL.get(i)+"             ");
		System.out.print(listss.ageL.get(i)+"     ");
		System.out.print(listss.genderL.get(i)+"        ");
		System.out.print(listss.phoneNoL.get(i)+"              ");
		System.out.print(listss.emailIdL.get(i)+"                      ");
		System.out.print(listss.cityL.get(i)+"              ");
		System.out.print(listss.addressL.get(i));
		System.out.println();
		}
		System.out.println();
	}
